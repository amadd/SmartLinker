...
class Liaison
{
     ...
     * @var string
     *
     * @ORM\Column(name="SiteConstructionId", type="string", length=255)
     */
    private $siteConstructionId;
    ...
    /**
     * Set siteConstructionId
     *
     * @param string $siteConstructionId
     * @return Liaison
     */
    public function setSiteConstructionId($siteConstructionId)
    {
        $this->siteConstructionId = $siteConstructionId;

        return $this;
    }

    /**
     * Get siteConstructionId
     *
     * @return string
     */
    public function getSiteConstructionId()
    {
        return $this->siteConstructionId;
    }
